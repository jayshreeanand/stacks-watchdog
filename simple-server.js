// A simplified version of the Chain Shield AI server for testing
...
app.get("/", (req, res) => {
  res.status(200).json({
    message: "Chain Shield AI API is running (Simple Mode)",
    version: "1.0.0",
    mode: "in-memory",
  });
});
...
server.listen(PORT, () => {
  console.log(`Simple Chain Shield AI server running on port ${PORT}`);
