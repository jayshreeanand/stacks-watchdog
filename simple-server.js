// A simplified version of the ETN Watchdog server for testing
...
app.get('/', (req, res) => {
  res.status(200).json({ 
    message: 'ETN Watchdog API is running (Simple Mode)',
    version: '1.0.0',
    mode: 'in-memory'
  });
});
...
server.listen(PORT, () => {
  console.log(`Simple ETN Watchdog server running on port ${PORT}`);
